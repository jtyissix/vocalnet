...
class ModelArguments:
    ...
    mm_tunable_parts: Optional[str] = field(
        default=None, metadata={"help": 'Could be "speech_projector", "speech_generator", "mm_vision_tower,mm_mlp_adapter,mm_language_model", "mm_vision_tower,mm_mlp_adapter,mm_language_model", "mm_mlp_adapter,mm_language_model"'}
    ) # TODO
