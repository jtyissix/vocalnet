...
COSYVOICE_MODEL="/home/jiangtianyuan/resource/voice/vocalnet/cosyvoice/model/"   ## CosyVoice2-0.5B       i.e. /workspace/CosyVoice/pretrained_models/CosyVoice2-0.5B-VocalNet
VOCALNET_MODEL = "/home/jiangtianyuan/resource/voice/vocalnet/checkpoints/8B/"
...
class VocalNetModel:
    ...
    def __initilize__(self):
        if self.empty:
            ...
            device_map = infer_auto_device_map(self.model, max_memory={
...
if __name__ == "__main__":
    ...
    '''
    q_audio="./omni_speech/infer/llama_questions_42.wav"
    audio_messages = [{"role": "user", "content": "<speech>","path": q_audio}]
